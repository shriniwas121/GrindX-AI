    ...
    return (
      ...
      >
        ...
        >
          <aside
            className={cn(
              "fixed top-16 left-0 z-50 h-[calc(100dvh-8.5rem)] max-h-[calc(100dvh-8.5rem)] w-[86vw] max-w-[320px] transform transition-all duration-300 ease-in-out sm:w-72 lg:static lg:z-10 lg:h-full lg:w-auto lg:max-w-none lg:translate-x-0 lg:p-2",
              theme === "dark"
